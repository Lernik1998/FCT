<template>
    ...
    >
        <!-- Sidebar de usuarios -->
        <div
            v-show="!selectedUser || !isMobile"
            class="w-full md:w-1/4 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col"
        >
            <div
                v-show="!isMobile"
                class="p-4 bg-blue-600 text-white font-bold text-lg border-b border-gray-200 dark:border-gray-700"
            >
                Usuarios
            </div>
        ...
        >
            ...
            <div v-if="isMobile" class="p-2 bg-blue-600 text-white md:hidden">
                <button
            ...
            <template v-else>
                ...
                >
                    <div
                        class="w-10 h-10 bg-blue-200 dark:bg-blue-700 rounded-full"
                    ></div>
                    <div class="ml-3">
...
defineOptions({ layout: TrainerLayout });
