...
<pre>{{ activity }}</pre>
    ...
    <section class="bg-gray-100 dark:bg-gray-900 py-6 sm:py-12 px-4 sm:px-6 flex justify-center transition-colors duration-300">
        <div
        ...
        >
            <!-- Título -->
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white text-center mb-4 sm:mb-6">
                {{ activity.name }}
            </h1>
            ...
            <div class="space-y-3 sm:space-y-4">
                <!-- Descripción -->
                <div class="bg-gray-50 dark:bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm transition-colors duration-300">
                    <h2 class="text-base sm:text-lg font-semibold text-gray-700 dark:text-gray-200">
                        Descripción
                    </h2>
                    ...
                    <p v-if="showFullDescription" class="text-gray-600 dark:text-gray-300 mt-1 text-sm sm:text-base">
                        {{ activity.description }}
                    </p>
                </div>
                ...
                <!-- Imagen -->
                <div class="bg-gray-50 dark:bg-gray-700 p-3 sm:p-4 rounded-lg shadow-sm transition-colors duration-300">
                    <h2 class="text-base sm:text-lg font-semibold text-gray-700 dark:text-gray-200 mb-2">
                        Imagen
                    </h2>
                    <div class="overflow-hidden rounded-lg">
                        <img v-if="activity.image"
