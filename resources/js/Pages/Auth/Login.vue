<template>
    ...
    >
        ...
        >
            ...
            >
                <h2 class="text-3xl font-extrabold text-gray-800">FitWorking</h2>
            ...
            <div class="px-8 py-8">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <!-- Botón de login -->
                    <PrimaryButton
                        class="mt-4 w-full bg-gradient-to-r  hover:from-orange-600 hover:to-amber-700 text-white focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900"
